...
>
  <head>
    ...
    <title>Users - Accounting Department</title>
        ...
        <div class="layout-page">
              ...
              <form method="POST" action="">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <div class="btn-group" role="group">
                              ...
                              <a href="userlist.php" type="button" class="btn btn-secondary" >Clear</a>
                  </div>
                </div>
          ...
          <!-- / Navbar -->
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>User List</h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="mt-3">
                        ...
                        <a href="resetpwlist.php" type="button" class="btn btn-warning"><span class="badge badge-center rounded-pill bg-danger" >
                          ...
                          echo $pwreq ?></span>&nbsp;Reset Password Requests</a>
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="submit" value="Add User" class="btn btn-primary" name="submit">Add User</button>
                              </div>
                            </div>
                          </div>
                        </div>
