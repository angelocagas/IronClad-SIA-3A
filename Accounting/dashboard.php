                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Welcome, <?= $fetch_profile['fullname']; ?></h5>
                          <p class="mb-4">
                            You have <span class="fw-bold"><?php $numreq = $conn->query("SELECT COUNT(*) from `requests` WHERE `status` = 'pending'")->fetchColumn();
                            echo $numreq ?></span> pending Accounting requests. Do your job, lazy ass!
                          </p>
                          <div class="dropdown">
                              <button
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="growthReportId">
                                ...
                                echo $numreq ?></span></a>
                                <a class="dropdown-item" href="rentalsalesreq.php">Rental and Sales &nbsp;<span class="badge badge-center rounded-pill bg-danger" ><?php $numreq = $conn->query("SELECT COUNT(*) from `requests` WHERE `account` = 'rental and sales' and `status` = 'pending'")->fetchColumn();
                                echo $numreq ?></span></a>
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Active Account Groups</span>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <a href="journals.php"><img src="../assets/img/icons/unicons/wallet-info.png" alt="Credit Card" class="rounded" /></a>
                            </div>
                           </div>
                          <span class="d-block mb-1">Journal Entries</span>
                          <h3 class="card-title text-nowrap mb-2"><?php $row = $conn->query('SELECT COUNT(*) from `journal`')->fetchColumn();
                          echo $row; ?></h3>
                        </div>
                      </div>
                    </div>
