...
>
  <head>
    ...
    <title>Journals - Accounting Department</title>
            ...
            <form method="POST" action="">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <div class="btn-group" role="group">
                              ...
                              <a href="journals.php" type="button" class="btn btn-secondary" >Clear</a>
                  </div>
                </div>
...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Journal Entries</h4>
              ...
              <!-- Vertically Centered Modal -->
                    <div class="col-lg-4 col-md-6">
                      <div class="mt-3">
                        ...
                        $select_journal = $conn->prepare("SELECT * FROM `journal` ORDER BY `journal_id` DESC LIMIT 1");
                        $select_journal->execute();
                        $fetch_journal = $select_journal->fetch(PDO::FETCH_ASSOC);
                        ?>
                        <form action="journalnew.php" method="post">
                        <!-- Modal -->
                        <div class="modal fade" id="modalCenter3" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add New Journal Entry</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="row">
                                <div class="mb-3">
                                  <label for="encoder" class="form-label">Journal ID</label>
                                    <div class="col-md-12">
                                    <input class="form-control" type="text" value="<?= $fetch_journal['journal_id'] + 1; ?>" id="jid" name="jid" readonly/>
                                    </div>
                                 </div>
                                </div>
                              <div class="row">
