...
>
  <head>
    ...
    <title>Forgot Password - Ironclad Sales/Rentals</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="login.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Ironclad Sales/Rentals</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Forgot Password? 🔒</h4>
              <form class="mb-3" action="forgetpwreq.php" method="POST">
                <div class="mb-3">
