            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <form method=POST action="">
                <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="date" value="" id="html5-date-input" name="ondate" required/>
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">Employee</label>
                        <div class="col-md-10">
                        <select id="defaultSelect" class="form-select" name="username" value="" required>
                                    <option>Select Employee Username</option>
                                    <?php

                                    $accounts = $pdo_conn->prepare("select * from `admintb` ");
                                    $accounts->execute();
