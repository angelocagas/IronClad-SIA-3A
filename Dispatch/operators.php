      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Operators</h4>           
<!--dito yung table-->
 ...
 <div class="col-lg-4 col-md-6">
                      <div class="mt-3">
                        ...
                        <form action="addoperators.php" method="post">
                        <!-- Modal -->
                        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add Operator</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="row">
                                  ...
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Certification Level</label>
                                    <select class="select2 form-select" name="certification">
                                    <option>Novice Operator</option>  
                                    <option>Intermidiate Operator</option>
                                    <option>Grade A Operator</option>
                                    <option>Grade B Operator</option>
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                   ...
                                   <td><?php echo $cert; ?></td>
                                  <td><button id="<?php echo $id ?>"onclick="window.location.href='ManageOperator.php'" type="button" class="btn btn-warning" action="ManageOperator.php">Edit</button></td>
                    <?php
                         }
