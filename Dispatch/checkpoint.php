      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="operators.php" class="menu-link">
 ...
 <!-- Vertically Centered Modal -->
  <div class="col-lg-4 col-md-6">
                      <div class="mt-3">
                        ...
                        <form action="addcheckpoint.php" method="post">
                        <!-- Modal -->
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="col mb-3">
                                ...
                                <select class="select2 form-select" name="checktime">
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                  ...
                                  <td><button id="<?php echo $id ?>"onclick="window.location.href='managecheckpoint.php'" type="button" class="btn btn-warning" action="managecheckpoint.php">Edit</button></td>
                    <?php
                         }
