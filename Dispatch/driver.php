                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add Driver</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">license Number</label>
                                    <input
                                      type="text"
                                      class="form-control"
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">license Expiry</label>
                                    <input
                                      type="text"
                                      class="form-control"
                                      placeholder="Enter License Number"
                                ...
                                <div class="row">
                                  ...
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Assigned Carrier</label>
                                    <select class="select2 form-select" name="acarrier">
                                    <option>Select Assigned Carrier</option>  
                                    <option>Tilt-deck Trailers</option>
                                    <option>Flatbed Trailer</option>
                                    <option>Lowboy Trailer</option>
                                    <option>Multi-axle Trailer</option>
                                    <option>Self-propelled Modular Transporter</option>
                                    <option>Platform Trailer</option>
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                  ...
                                  <td><button onclick="window.location.href='Manage-Drivers.php'" type="button" class="btn btn-warning" action="Manage-Drivers.php">Edit</button></td>
                    <?php
                         }
