                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add Operation</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Dispatch Date</label>
                                    <input class="form-control" type="date" value="<?php echo date("Y-m-d"); ?>" id="html5-date-input" name="dispatchdate"/>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Dispatch location</label>
                                    <input
                                      type="text"
                                      class="form-control"
                                  ...
                                  <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Driver ID</label>
                                    <input
                                      type="text"
                                      class="form-control"
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Operator ID</label>
                                    <input
                                      type="text"
                                      id="phone"
                                      class="form-control"
                                ...
                                <div class="row">
                                  ...
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Estimated Time</label>
                                    <select class="select2 form-select" name="estimatedtime">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Operation Status</label>
                                    <select class="select2 form-select" name="opstatus">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary" name="submit">Add Operation</button>
                              </div>
                            </div>
                          </div>
                        </div>
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                  ...
                                  <td><button id="<?php echo $id ?>"onclick="window.location.href='managefleet.php'" type="button" class="btn btn-warning" action="managefleet.php">Edit</button></td>
                    <?php
                         }
