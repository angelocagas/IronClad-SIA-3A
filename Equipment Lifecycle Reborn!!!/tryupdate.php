                        ...
                        <form action="updateuser.php" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="username" placeholder="Please double check the username, it will show an error if the username does not match." name="username" value="<?php echo $user['username']; ?>" required readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="cpass" placeholder="****" name="cpass" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="phone" placeholder="" name="phone" value="<?php echo $user['phone']; ?>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
