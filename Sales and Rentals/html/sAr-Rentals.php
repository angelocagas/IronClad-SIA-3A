      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
                 <li class="menu-item ">
              <a href="sAr-Sale.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Analytics">Sales</div>
              </a>
            </li>
            <li class="menu-item active">
              <a href="sAr-Rentals.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
            ...
            <li class="menu-item ">
              <a href="sAr-inventory.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
...
$ret=mysqli_query($con,"select * from rentals");
$cnt=1;
...
?>        
                    ...
                    <td><?php if($row['status_document'] == 0){
                        ...
                        <td>
                        <a href="edit_pending_rental.php?property_id=<?php echo htmlentities ($row['rental_id']);?>" class="view" title="View" data-toggle="tooltip">Action</a>
                        </td>
            <!--                   <td>
                         
                            <a href="approved.php?property_id=<?php echo htmlentities ($row['rental_id']);?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="rental.php?delid=<?php echo ($row['rental_id']);?>&&ppic=<?php echo $row['file_img'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
          -->
                    </tr>
