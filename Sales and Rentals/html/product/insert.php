...
move_uploaded_file($_FILES["product_image"]["tmp_name"],"product_image/".$imgnewfile);
// Query for data insertion
$query=mysqli_query($con, "insert into product_tbl(FirstName,LastName, MobileNumber, Email, Address,ProfilePic) value('$fname','$lname', '$contno', '$email', '$add','$imgnewfile' )");
if ($query) {
