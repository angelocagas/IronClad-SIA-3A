      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <!-- card -->
            <h3>Equipment Approval Request</h3>
...
?>        
                   ...
                   <td>
                           <a href="view_products.php?viewid=<?php echo htmlentities ($row['equipment_id']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <a href="edit_products.php?editid=<?php echo htmlentities ($row['equipment_id']);?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="equipment.php?delid=<?php echo ($row['equipment_id']);?>&&ppic=<?php echo $row['file_img'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
